...
public final class _PremiumAccountDelD extends Ice._ObjectDelD implements _PremiumAccountDel
{
    ...
    public void calculateLoan(final int amount, final Currency curr, final int period, final Ice.FloatHolder interestRate, final Ice.IntHolder totalCost, java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper,
               IncorrectData
    {
        final Ice.Current __current = new Ice.Current();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    try
                    {
                        __servant.calculateLoan(amount, curr, period, interestRate, totalCost, __current);
                        return Ice.DispatchStatus.DispatchOK;
                    }
                    catch(Ice.UserException __ex)
                    {
