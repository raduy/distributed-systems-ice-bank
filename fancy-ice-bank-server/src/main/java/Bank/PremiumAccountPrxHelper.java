...
public final class PremiumAccountPrxHelper extends Ice.ObjectPrxHelperBase implements PremiumAccountPrx
{
    ...
    private static final String __transferMoney_name = "transferMoney";

    public void transferMoney(String accountNumber, int amount)
        throws IncorrectAccountNumber,
               IncorrectAmount
    {
        transferMoney(accountNumber, amount, null, false);
    }

    public void transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx)
        throws IncorrectAccountNumber,
               IncorrectAmount
    {
        transferMoney(accountNumber, amount, __ctx, true);
    }

    private void transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws IncorrectAccountNumber,
               IncorrectAmount
    {
        if(__explicitCtx && __ctx == null)
        ...
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "transferMoney", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
            {
                ...
                try
                {
                    __checkTwowayOnly("transferMoney");
                    __delBase = __getDelegate(false);
                    _PremiumAccountDel __del = (_PremiumAccountDel)__delBase;
                    __del.transferMoney(accountNumber, amount, __ctx, __observer);
                    return;
                }
                catch(IceInternal.LocalExceptionWrapper __ex)
                {
    ...
    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount)
    {
        return begin_transferMoney(accountNumber, amount, null, false, null);
    }

    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx)
    {
        return begin_transferMoney(accountNumber, amount, __ctx, true, null);
    }

    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, Ice.Callback __cb)
    {
        return begin_transferMoney(accountNumber, amount, null, false, __cb);
    }

    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_transferMoney(accountNumber, amount, __ctx, true, __cb);
    }

    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, Callback_Account_transferMoney __cb)
    {
        return begin_transferMoney(accountNumber, amount, null, false, __cb);
    }

    public Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx, Callback_Account_transferMoney __cb)
    {
        return begin_transferMoney(accountNumber, amount, __ctx, true, __cb);
    }

    private Ice.AsyncResult begin_transferMoney(String accountNumber, int amount, java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__transferMoney_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __transferMoney_name, __cb);
        try
        {
            __result.__prepare(__transferMoney_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
    ...
    public void end_transferMoney(Ice.AsyncResult __result)
        throws IncorrectAccountNumber,
               IncorrectAmount
    {
        Ice.AsyncResult.__check(__result, this, __transferMoney_name);
        boolean __ok = __result.__wait();
        try
        {
            if(!__ok)
    ...
    {
        calculateLoan(amount, curr, period, interestRate, totalCost, null, false);
    }
    ...
    public void calculateLoan(int amount, Currency curr, int period, Ice.FloatHolder interestRate, Ice.IntHolder totalCost, java.util.Map<String, String> __ctx)
        throws IncorrectData
    {
        calculateLoan(amount, curr, period, interestRate, totalCost, __ctx, true);
    }

    private void calculateLoan(int amount, Currency curr, int period, Ice.FloatHolder interestRate, Ice.IntHolder totalCost, java.util.Map<String, String> __ctx, boolean __explicitCtx)
        throws IncorrectData
    {
        if(__explicitCtx && __ctx == null)
        {
        ...
        try
        {
            while(true)
            {
                ...
                try
                {
                    ...
                    __delBase = __getDelegate(false);
                    _PremiumAccountDel __del = (_PremiumAccountDel)__delBase;
                    __del.calculateLoan(amount, curr, period, interestRate, totalCost, __ctx, __observer);
                    return;
                }
                catch(IceInternal.LocalExceptionWrapper __ex)
                {
