package pl.agh.sr.icebank.evictor.baseevictor;

public abstract class
        EvictorBase implements Ice.ServantLocator {
    public EvictorBase() {
        _size = 1000;
    }
    ...
    private pl.agh.sr.icebank.evictor.baseevictor.LinkedList<Ice.Identity> _queue =
            new pl.agh.sr.icebank.evictor.baseevictor.LinkedList<>();
    private int _size;
}
